...
import { getAge, getDayTimeToMinutes, getBestTimeDelta, getLocalMonths, getTimeSpan, getGreeting,
  getNicks, makeTheTimeObject, getTimeDelta, monthStr3, monthStr, weekday3, ITheTime, } from './dateServices';
...
/***
 *    d888888b      db    db .d8888. d88888b d8888b. 
 *      `88'        88    88 88'  YP 88'     88  `8D 
 *       88         88    88 `8bo.   88ooooo 88oobY' 
 *       88         88    88   `Y8b. 88~~~~~ 88`8b   
 *      .88.        88b  d88 db   8D 88.     88 `88. 
 *    Y888888P      ~Y8888P' `8888Y' Y88888P 88   YD 
 *                                                   
 *                                                   
 */
